...
public class Principal {
	...
	public static void questao2_Print() {
		...
		for (int i=1;i<=10;i++) {
			int multiplicacao=5*i;
			System.out.println("5 x "+i+" = "+multiplicacao);
		}
	...
	public static void questao3_For() {
		...
		System.out.println("a soma de 1 ate 100 vale: "+soma);
		System.out.println();
	}
	...
	public static void questao5_While(Scanner scan) {
		...
		System.out.println("a soma dos valores digitados vale: "+soma);
		System.out.println();
	}
	...
	public static void questao6_Metodos() {
		...
		System.out.println("o maior numero vale: "+encontrarMaior(n1,n2));		
		System.out.println();
	}
	...
	public static void questao10_MetodosFor() {
		...
		System.out.println("o fatorial de 5 vale: "+calcularFatorial(5));
		System.out.println("o fatorial de 7 vale: "+calcularFatorial(7));
